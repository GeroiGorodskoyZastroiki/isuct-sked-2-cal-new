...
В конце, перед формированием файла календаря вы будете выбирать схему компоновки параметров, из которых формируется название пары, там вы можете не любой из параметров (тип пары, название предмета, аудитория, преподователь) в итоговое название event'a календаря
